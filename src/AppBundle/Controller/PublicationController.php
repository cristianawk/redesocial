        ...
        if($form->isSubmitted()){
            if($form->isValid()){
                ...
                if(!empty($file) && $file != null){
                    ...
                    //echo"<br>extensao imagem: ";var_dump($ext);
                    //die();

                    if($ext == 'jpg' || $ext == 'jpeg' || $ext == 'png' || $ext == 'gif' || $ext == 'tmp'){
                        //var_dump($ext);
                        //die();
                ...
                //echo"<br>documento: ";var_dump($doc);

                if(!empty($doc) && $doc != null){
                    //echo"<br>entrou ";
                    $ext = $doc->guessExtension();
                    echo"<br>extensao documento: ";var_dump($GLOBALS);
                    //die();
